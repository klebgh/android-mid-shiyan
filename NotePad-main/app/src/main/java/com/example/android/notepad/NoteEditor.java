...
public class NoteEditor extends Activity {
    ...
    private String mCurrentCategory = "未定义";
    private static final String[] CATEGORIES = {"工作", "学习", "生活", "未定义"};
    private static final String[] CATEGORY_VALUES = {"work", "study", "life", "undefined"};
    ...
    private EditText mTitleText;  // 新增：标题编辑框
    private EditText mContentText; // 修改：内容编辑框
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 在 onCreate 方法中 setContentView 之后添加
...
// 设置分类选择监听器
        mCategorySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                mCurrentCategory = "undefined";
            }
        });
        // Gets a handle to the EditText in the the layout.
        mTitleText = (EditText) findViewById(R.id.title);  // 新增：标题编辑框
        mContentText = (EditText) findViewById(R.id.note); // 修改：内容编辑框
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
            ...
            mContentText.setTextKeepState(note);
            ...
            mTitleText.setText(getText(R.string.error_message));
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        String currentNote = mContentText.getText().toString();
        if (savedTitle.equals(currentTitle) && savedNote.equals(currentNote)) {
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String title, String text) {
        ...
        // If no title was provided, create one from the note text.
        ...
        // In the values map, sets the value of the title and note
